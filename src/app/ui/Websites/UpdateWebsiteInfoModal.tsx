...
export default function UpdateWebsiteInfoModal({websiteId}: {websiteId: string}) {
    ...
    return (
        <div>
            <Button onClick={handleOpen} variant={'contained'} fullWidth sx={{mt: 2}} color={'warning'}>Update
                Data</Button>
            <Dialog
                open={open}
                fullWidth={true}
