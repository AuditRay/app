...
import {createFiltersViews, updateFiltersViews, updateList} from "@/app/actions/filterViewsActions";
...
export default function UpdateFilterViewModal({open, setOpenAction, list, filters}: {open: boolean, setOpenAction: (open: boolean) => void, list: IList, filters: {
        text?: string;
        name?: string;
        type?: string[];
        folder?: string[];
