...
import {deleteList} from "@/app/actions/filterViewsActions";

export default function DeleteListModal({open, setOpen, listId, workspaceId}: {open: boolean, setOpen: (open: boolean) => void, listId: string, workspaceId: string}) {
