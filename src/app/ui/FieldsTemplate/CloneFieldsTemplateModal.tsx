...
import {Autocomplete, Chip, Divider, FormControl, Grid, InputLabel, Paper, Select} from "@mui/material";
import {createFiltersViews} from "@/app/actions/filterViewsActions";
import {createWorkspace} from "@/app/actions/workspaceActions";
import {Field, IFieldsTemplate} from "@/app/models";
...
export default function CloneFieldsTemplateModal({open, setOpen, fieldsTemplate, workspaceId}: {workspaceId: string; fieldsTemplate: IFieldsTemplate, open: boolean, setOpen: (open: boolean) => void}) {
    ...
    const [fields, setFields] = useState<Field[]>([...fieldsTemplate.fields]);
    ...
    return (
        <Dialog
            ...
            scroll={'paper'}
        >
            <DialogTitle>Clone fields template</DialogTitle>
            <DialogContent>
                <TextField
                    autoFocus
                    disabled={isSaving}
