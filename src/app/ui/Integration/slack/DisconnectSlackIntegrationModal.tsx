...
import {disconnectSlackToken} from "@/app/actions/integrations/slackActions";

export default function DisconnectSlackIntegrationModal({open, setOpen, workspaceId}: {workspaceId: string, open: boolean, setOpen: (open: boolean) => void}) {
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            async function disconnectIntegration() {
                                await disconnectSlackToken(workspaceId);
                            }
